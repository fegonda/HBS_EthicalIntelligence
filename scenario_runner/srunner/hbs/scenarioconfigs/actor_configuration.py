...
class HBSActorConfigurationData(ActorConfigurationData):
    ...
    def __init__(self, model, transform, rolename='other', speed=0, autopilot=False,
        ...
        super(HBSActorConfigurationData, self).__init__(
                model, 
                transform, 
                rolename=rolename, 
                speed=speed, 
    ...
    def parse_from_node(node, rolename):
        ...
        return HBSActorConfigurationData(
            model, 
            transform, 
            rolename, 
            speed, 
            ...
            awareness_distance=awareness_distance, 
            trigger_distance=trigger_distance, 
            destination_is_waypoint=destination_is_waypoint,
